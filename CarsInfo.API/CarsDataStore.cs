...
namespace CarsInfo.API
{
    public class CarsDataStore
    {
        ...
        public CarsDataStore()
        {
            ...
            {
                new CarDto() { Id = 1, Name = "BMW", Model = "X5", Year = 2020 , PointsOfInterest = new List<PointOfInterestDto>{new PointOfInterestDto(){Id = 5, Name = "german", Description = "germanise car"} } },
